...
const Slide = (props: SlideProps) => {
  ...
  return (
    <div
      key={key}
      class={`${props.class} ${color} h-screen w-full flex flex-col justify-center items-center text-center text-black p-5`}
    >
      {text}
      
      <img src={url} alt={text} />
      <a href="https://open.spotify.com/artist/2KVIIBDZWAm5G5szCsN7tV?si=sMn1uNjjT6Cwi60K2143bw" target="_blank" rel="noopener noreferrer">
        <ColoredButton>Listen Now</ColoredButton>
      </a>
    </div>
  );
};
